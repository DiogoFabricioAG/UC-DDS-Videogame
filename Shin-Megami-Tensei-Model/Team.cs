...
public class Team
{
    ...
    public Unit[] GetUnitsStillAlive() => StartingTeam.Where(x => x != null && !x.Defeated).ToArray();
    public Unit[] GetSelectableUnitsForAllAttacks() => StartingTeam.Where(x => x != null).ToArray();
